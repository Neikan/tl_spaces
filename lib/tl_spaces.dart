...
abstract class TlSpaces {
  ...
  static const ph6 = EdgeInsets.symmetric(horizontal: sp6);
  ...
  static const ph56 = EdgeInsets.symmetric(horizontal: sp56);
  static const ph64 = EdgeInsets.symmetric(horizontal: sp64);

  // Vertical
  static const pv4 = EdgeInsets.symmetric(vertical: sp4);
  static const pv6 = EdgeInsets.symmetric(vertical: sp6);
  ...
  static const pv64 = EdgeInsets.symmetric(vertical: sp64);

  // Symmetric
  static const ph8v4 = EdgeInsets.symmetric(horizontal: sp8, vertical: sp4);
  static const ph8v12 = EdgeInsets.symmetric(horizontal: sp8, vertical: sp12);
  ...
  static const ph12v16 = EdgeInsets.symmetric(horizontal: sp12, vertical: sp16);
  ...
  static const ph20v8 = EdgeInsets.symmetric(horizontal: sp20, vertical: sp8);
  static const ph20v12 = EdgeInsets.symmetric(horizontal: sp20, vertical: sp12);
  static const ph20v16 = EdgeInsets.symmetric(horizontal: sp20, vertical: sp16);
  ...
  // Bottom
  static const pb2 = EdgeInsets.only(bottom: sp2);
  ...
  static const pb20 = EdgeInsets.only(bottom: sp20);
  static const pb24 = EdgeInsets.only(bottom: sp24);
  static const pb32 = EdgeInsets.only(bottom: sp32);
  static const pb40 = EdgeInsets.only(bottom: sp40);
  static const pb48 = EdgeInsets.only(bottom: sp48);
  static const pb56 = EdgeInsets.only(bottom: sp56);
  ...
  static const pt56 = EdgeInsets.only(top: sp56);
  ...
  static const pl40 = EdgeInsets.only(left: sp40);
  static const pl48 = EdgeInsets.only(left: sp48);
  static const pl56 = EdgeInsets.only(left: sp56);
  ...
  static const pr40 = EdgeInsets.only(right: sp40);
  static const pr48 = EdgeInsets.only(right: sp48);
  static const pr56 = EdgeInsets.only(right: sp56);
  static const pr64 = EdgeInsets.only(right: sp64);
  ...
  static const pl8r24 = EdgeInsets.only(left: sp8, right: sp24);
  static const pl16r8 = EdgeInsets.only(left: sp16, right: sp8);
  static const pl16b8 = EdgeInsets.only(left: sp16, bottom: sp8);
  static const pl16t16 = EdgeInsets.only(left: sp16, top: sp16);
  ...
  static const pr16b16 = EdgeInsets.only(bottom: sp16, right: sp16);
  ...
  static const ph16t24b8 = EdgeInsets.fromLTRB(sp16, sp24, sp16, sp8);
  static const ph16b4 = EdgeInsets.fromLTRB(sp16, 0.0, sp16, sp4);
  static const ph16b8 = EdgeInsets.fromLTRB(sp16, 0.0, sp16, sp8);
  static const ph16b16 = EdgeInsets.fromLTRB(sp16, 0.0, sp16, sp16);
  static const ph16b24 = EdgeInsets.fromLTRB(sp16, 0.0, sp16, sp24);
  ...
  static const ph24b12 = EdgeInsets.fromLTRB(sp24, 0.0, sp24, sp12);

  static const ph24t16 = EdgeInsets.fromLTRB(sp24, sp16, sp24, 0.0);
  static const ph24b16 = EdgeInsets.fromLTRB(sp24, 0.0, sp24, sp16);
